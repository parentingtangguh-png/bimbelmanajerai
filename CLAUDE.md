...
- **Dikunci 14 Sep 2026:** arsitektur, Matriks Cakupan Bahan beserta amendemen (`docs/curriculum/matriks-cakupan-bahan.md`), dan 96 milestone (`docs/curriculum/milestone-12x8.md`). Perubahan hanya lewat keputusan eksplisit pemilik. **Tahap berjalan: 96 indikator operasional** (Kompetensi · Cara uji · Bahan · Tanda lulus; draf Codex → audit Claude, per alur). **Alur A dan B dikunci** (`docs/curriculum/indikator/alur-a.md`, `alur-b.md`); Alur C–F belum. Belum ada perubahan kode, database, atau logika diagnostik.
