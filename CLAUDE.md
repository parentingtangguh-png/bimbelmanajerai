...
- **Pekerjaan berikutnya yang diusulkan, menunggu pilihan pemilik** (saran Claude urut): (1) ~~panduan~~ **selesai** (lihat Panduan per tab); (2) **uji Prompt kegiatan di ChatGPT** untuk kelas 3/4/5 anak (batas ±400 kata); (3) periksa menu utama yang tampak terpotong di pane sempit. Opsional: rapor/laporan orang tua, periksa cadangan data Supabase.
