...
- **Dikunci 14 Sep 2026:** arsitektur, Matriks Cakupan Bahan beserta amendemen (`docs/curriculum/matriks-cakupan-bahan.md`), dan 96 milestone (`docs/curriculum/milestone-12x8.md`). Perubahan hanya lewat keputusan eksplisit pemilik. **96 indikator operasional selesai dan dikunci** (Alur A–F, `docs/curriculum/indikator/alur-a.md` … `alur-f.md`; A–E 14 Sep, F 15 Sep 2026). **English & Karakter:** matriks + milestone dikunci 15 Sep 2026 (`docs/curriculum/english-karakter.md`); 16 indikatornya belum. **Belum dimulai:** judul/deskripsi level, CP, tema, aturan tes diagnostik baru, rencana perubahan aplikasi; uji coba dengan anak disarankan sebelum pembangunan. Belum ada perubahan kode, database, atau logika diagnostik.
