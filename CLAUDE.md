...
- **Dikunci 14 Sep 2026:** arsitektur, Matriks Cakupan Bahan beserta amendemen (`docs/curriculum/matriks-cakupan-bahan.md`), dan 96 milestone (`docs/curriculum/milestone-12x8.md`). Perubahan hanya lewat keputusan eksplisit pemilik. **Tahap berjalan: 96 indikator operasional** (Kompetensi · Cara uji · Bahan · Tanda lulus; draf Codex → audit Claude, per alur). **Alur A–E dikunci** (`docs/curriculum/indikator/alur-a.md` … `alur-e.md`); Alur F belum. Belum ada perubahan kode, database, atau logika diagnostik.
