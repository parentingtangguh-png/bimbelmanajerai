...
- **Ruang kelas — tahap 1 sudah dibangun (14 Sep 2026): jadwal pertemuan.** Formulir (urutan diputuskan pemilik): **Siswa** (dropdown pilih banyak; yang belum dites tidak bisa dicentang) → **Tema** → **Indikator per siswa** (dropdown dari level siswa masing-masing; **tidak ada dropdown CP dan Level**) → **Pertemuan** (otomatis nomor terbesar + 1, bisa diganti; mengganti pertemuan memilihkan tema yang berlaku) → **Tanggal**, **Jam**. Daftar dibagi **Akan datang** / **Selesai**; Ubah/Hapus hanya sebelum selesai. **Tahap 2 (belum)**: buka jadwal saat kelas → Lulus/Belum per siswa → "Tandai pertemuan selesai" (isi `completed_at`); indikator awal di dropdown nanti = indikator berikutnya yang belum lulus. Catatan: formulir saat ini membiarkan guru memilih indikator mana pun dari level siswa (keputusan pemilik "guru memilih indikator yang disarankan"), berbeda dari butir 4 di bawah yang otomatis berurutan — konfirmasi ke pemilik saat tahap 2.
