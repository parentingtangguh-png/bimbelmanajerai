...
- **Rencana aplikasi** [`docs/rencana-aplikasi.md`](docs/rencana-aplikasi.md): Fase 1 (isi kurikulum + halaman Kurikulum), 2 (tes diagnostik baru), 3 (Ruang kelas baru), 4 (pembersihan kurikulum pilot), 5 (tombol **Prompt kegiatan**) **sudah di produksi**. Rencana aplikasi selesai.
