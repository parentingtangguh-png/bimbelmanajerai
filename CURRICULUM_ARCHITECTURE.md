...
4. 96 indikator operasional (Kompetensi · Cara uji · Bahan · Tanda lulus) — disusun Codex, diaudit Claude, per alur. ← *tahap berjalan*: **Alur A–E dikunci 14 Sep 2026** ([`alur-a.md`](docs/curriculum/indikator/alur-a.md), [`alur-b.md`](docs/curriculum/indikator/alur-b.md), [`alur-c.md`](docs/curriculum/indikator/alur-c.md), [`alur-d.md`](docs/curriculum/indikator/alur-d.md), [`alur-e.md`](docs/curriculum/indikator/alur-e.md)); Alur F belum.
