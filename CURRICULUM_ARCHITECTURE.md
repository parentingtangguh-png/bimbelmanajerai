...
- English dan Karakter masing-masing memiliki 1 indikator per level dan dicatat sebagai hasil pendamping. Keduanya dinilai Lulus/Belum pada tahap indikator operasional (English belum dinilai pada diagnostik anak baru), tetapi tidak menentukan perpindahan indikator akademik, kenaikan level, atau penentuan level awal diagnostik.
- **English per tema (amendemen 15 Sep 2026, disetujui pemilik):** English memakai bentuk campuran: pola/cara uji tetap per level, sedangkan kosakata L2, L3, L5, L6, dan L8 bersumber dari kosakata English tema yang dikenalkan dalam pembelajaran kelas (lihat `docs/curriculum/cp-level-tema.md`). L1 dan L7 memakai ungkapan tetap lintas tema. English tulisan memakai kata, frasa, atau kalimat utuh; tidak memakai phonics bahasa Inggris, nama huruf bahasa Inggris, atau pembunyian huruf bahasa Inggris.
- Semua kosakata English satu tema dianggap dikenalkan pada setiap pertemuan tema itu. Kosakata tema tersebut boleh dinilai bila anak hadir pada sedikitnya tiga pertemuan dalam tema itu, termasuk kosakata tema sebelumnya yang telah memenuhi syarat. Asesmen English dikecualikan dari aturan umum bahwa cara uji tidak bergantung pada pengajaran bimbel sebelumnya.
- Kata benda English tidak berulang antartema kecuali disengaja dan dicatat. Setiap tema menandai sedikitnya empat kata benda yang wajar diminta untuk pola L5. Setiap tema memuat sedikitnya empat frasa tindakan untuk L6, dengan sedikitnya dua frasa memakai kata benda yang sama dan kata kerja berbeda. Guru tidak melatih urutan butir, posisi kunci, atau format tes.
- Pada diagnostik anak baru, English dicatat belum dinilai dan mulai dinilai di kelas setelah syarat paparan terpenuhi.
...
- **CP, judul dan deskripsi 8 level, dan 8 tema** dikunci 15 Sep 2026: [`docs/curriculum/cp-level-tema.md`](docs/curriculum/cp-level-tema.md). Tema adalah konteks bersama kelas multi-level (8 tema × 4 subtema × 6 pertemuan), tidak menentukan indikator dan tidak mengubah bahan tes; hanya 12 kata terlindungi dari tulisan latihan tema.
- **Belum dikunci:** rencana perubahan aplikasi.
