...
4. 96 indikator operasional (Kompetensi · Cara uji · Bahan · Tanda lulus) — disusun Codex, diaudit Claude, per alur. ← *tahap berjalan*: **Alur A dikunci 14 Sep 2026** ([`docs/curriculum/indikator/alur-a.md`](docs/curriculum/indikator/alur-a.md)); Alur B–F belum.
