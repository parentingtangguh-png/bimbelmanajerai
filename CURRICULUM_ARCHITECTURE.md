...
4. 96 indikator operasional (Kompetensi · Cara uji · Bahan · Tanda lulus) — disusun Codex, diaudit Claude, per alur. ← *tahap berjalan*: **Alur A dan B dikunci 14 Sep 2026** ([`alur-a.md`](docs/curriculum/indikator/alur-a.md), [`alur-b.md`](docs/curriculum/indikator/alur-b.md)); Alur C–F belum.
